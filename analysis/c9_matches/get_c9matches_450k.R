...
saveRDS(matches_methylated_nomismatch_final, file = "../../data/processed/c9_matches/450k_matches_methylated_nomismatch_final.rds")
...
saveRDS(matches_unmethylated_nomismatch_final, file = "../../data/processed/c9_matches/450k_matches_unmethylated_nomismatch_final.rds")
...
saveRDS(matches_methylated_mismatch_indel_final, file = "../../data/processed/c9_matches/450k_matches_methylated_mismatch_indel_final.rds")
...
saveRDS(matches_unmethylated_mismatch_indel_final, file = "../../data/processed/c9_matches/450k_matches_unmethylated_mismatch_indel_final.rds")
...
saveRDS(matches_YpG_nomismatch_final, file = "../../data/processed/c9_matches/450k_matches_YpG_nomismatch_final.rds")
...
saveRDS(matches_YpG_mismatch_indel_final, file = "../../data/processed/c9_matches/450k_matches_YpG_mismatch_indel_final.rds")
