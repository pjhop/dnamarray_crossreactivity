...
--mlma-loco --out ../../data/output/ewas/mlma_loco_c9_covarsexbatch_qcovaragesmoking_total_intensities > ../logs/mlma_loco_c9_covarsexbatch_qcovaragesmoking_total_intensities.log
