...
pca <- readr::read_delim("../../data/processed/pca_total_intensities_oob_NL.eigenvec", col_names = FALSE, delim = " ")
samples <- pca$X1
pca$X1 <- pca$X2 <- NULL
...
## Save
write_tsv(qcovar, path = "../../data/temp/qcovar_predictedage_smoking_cellcounts_5controlPCs_5PCs_total_intensities_oob.txt", col_names=FALSE)
