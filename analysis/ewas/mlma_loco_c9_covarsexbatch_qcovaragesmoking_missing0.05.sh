...
--mlma-loco --out ../../data/output/ewas/mlma_loco_c9_covarsexbatch_qcovaragesmoking_missing0.05 > ../logs/mlma_loco_c9_covarsexbatch_qcovaragesmoking_missing0.05.log
