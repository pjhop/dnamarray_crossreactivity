...
--moment --out ../../data/output/ewas/mlma_moment_c9_covarsexbatch_qcovaragesmoking_missing0.05 > ../logs/mlma_moment_c9_covarsexbatch_qcovaragesmoking_missing0.05.log
