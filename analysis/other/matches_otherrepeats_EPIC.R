...
run <- function(lst) {
  matches <- map_probes_sequence(sequence = lst[["sequence"]], next_base = lst[["next_base"]], prev_base = lst[["prev_base"]],
                                 array = "EPIC", min_width = 10, max_width = 35, allow_indel = TRUE, 
...
saveRDS(matches_all, file = "../../data/misc/matches_repeat_sequences_10_35_useY_allowmismatch_allowINDEL_EPIC.rds")
...
saveRDS(matches_all_methylated, file = "../../data/misc/matches_repeat_sequences_10_35_methylated_allowmismatch_allowINDEL_EPIC.rds")
...
saveRDS(matches_all_unmethylated, file = "../../data/misc/matches_repeat_sequences_10_35_unmethylated_allowmismatch_allowINDEL_EPIC.rds")
